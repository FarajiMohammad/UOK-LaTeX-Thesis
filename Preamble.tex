...
\newcounter{subfigcounter} % Define a counter
\AtBeginEnvironment{figure}{\setcounter{subfigcounter}{0}}
\newcommand{\mysubfig}[2]{%
  \stepcounter{subfigcounter}% Increment counter
  \begin{minipage}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{#1}
    \caption*{(\alph{subfigcounter})\ #2}
  \end{minipage}\hfill
}
