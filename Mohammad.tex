...
\begin{document}
	...
	\include{STR-Files/TSVIR-FA}
	
	\include{STR-Files/cover-fa}
	%% evaluation page...
	\include{STR-Files/evaluation}
	%
	
	%% submission page...
	\include{STR-Files/submission-fa}
	%% acknowledgements page...
	\include{STR-Files/acknowledgements}
	%
	%% alphabetic page numbering for non-report pages...
	
	\newpage
	%% the abstract page...
	\include{STR-Files/abstract-fa}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{latin}
		...
		\newpage
		\input{STR-Files/abstract-en.tex}
		\newpage
		% english cover page...
		\input{STR-Files/Submission-en.tex}
		\input{STR-Files/cover-en.tex}
	\end{latin}	
	\newpage
	\input{STR-Files/TASVIR-En}
